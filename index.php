                        ...
                        <div class="col-lg-7 col-md-7 col-12">
                            <div class="single-about">
                                ...
                                <p>Sunrise India is Registered under Indian Partnership Act-1932.
                                    ...
                                    Group, Expression Group, Husk Power, Power one , R. N. Jwellers and much
                                    more.. . Our Organization has been entrusted by Govt. Organizations as Bihar
                                    Renewable Energy Development Agency and Jharkhand Renewable Energy
                                    Development Agency for a wide range of Solar Grid, Solar Pump , wind
                                    turbines , Solar Heater, Solar Photo voltaic Sector & Industrial
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title mb-4">
                        <h1 class="text-dark text-center">Services
                        </h1>
    ...
    <div class="testimonials">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="section-title mb-4">
                        <h1 class="text-dark text-center">Testimonial
                        </h1>
